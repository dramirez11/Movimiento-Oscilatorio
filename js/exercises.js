    ...
    resultContainer.innerHTML = `
      <div class="exercise-card" style="border-left: 5px solid #2563eb;">
        ...
        <div class="phase-box phase-despeje">
          ...
          <div style="font-size: 0.95rem; line-height: 1.8;">
            <p><strong>Paso 4.1: Cálculo de la frecuencia angular $\\omega$:</strong></p>
            $$ \\omega = \\sqrt{\\frac{${k.toFixed(2)} \\text{ N/m}}{${m.toFixed(2)} \\text{ kg}}} = \\sqrt{${(k/m).toFixed(3)}} \\implies $$
            <span class="solved-tag-orange">ω = ${omega.toFixed(4)} rad/s</span> (Ya no es incógnita)
            
            <p style="margin-top:10px;"><strong>Paso 4.2: Cálculo del periodo $T$ y la frecuencia $f$:</strong></p>
            $$ T = \\frac{2\\pi}{${omega.toFixed(4)} \\text{ rad/s}} \\implies $$
            <span class="solved-tag-orange">T = ${T.toFixed(4)} s</span> (Valor determinado)<br>
            $$ f = \\frac{1}{${T.toFixed(4)} \\text{ s}} \\implies $$
            <span class="solved-tag-orange">f = ${f.toFixed(4)} Hz</span> (Valor determinado)

            <p style="margin-top:10px;"><strong>Paso 4.3: Rapidez máxima $v_{\\max}$ y Aceleración máxima $a_{\\max}$:</strong></p>
            $$ v_{\\max} = (${omega.toFixed(4)} \\text{ rad/s}) \\cdot (${A.toFixed(3)} \\text{ m}) \\implies $$
            <span class="solved-tag-orange">v_max = ${vmax.toFixed(4)} m/s</span><br>
            ...
            <p style="margin-top:10px;"><strong>Paso 4.4: Energía mecánica total $E_m$:</strong></p>
